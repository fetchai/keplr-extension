...
# Comment
sed -i "s|$auto_lock|$auto_lock_replacement|g" "$file_path"
...
sed -i "s|$auto_lock_sinit|$auto_lock_sinit_replacement|g" "$file_path"
...
sed -i "s|$auto_lock_init|$auto_lock_init_replacement|g" "$file_path"
...
sed -i "s|$umbral|$umbral_replacement|g" "$file_path"
...
sed -i "s|$umbral_service|$umbral_service_replacement|g" "$file_path"
...
sed -i "s|$umbral_sinit|$umbral_sinit_replacement|g" "$file_path"
...
sed -i "s|$umbral_init|$umbral_init_replacement|g" "$file_path"
