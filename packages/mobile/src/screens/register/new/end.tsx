...
export const RegisterEndScreen: FunctionComponent = observer(() => {
  ...
  return (
    <PageWithView
      backgroundMode="image" backgroundBlur={true}
    ...
    >
      ...
      <View style={style.flatten(["items-center"])}>
        ...
        <LinearGradientText text="You’re all set!" color1="#CF447B" color2="#F9774B" />
      ...
      <Button
        containerStyle={
          style.flatten(["margin-top-44", "margin-bottom-20", "background-color-white", "border-radius-32"]) as ViewStyle
        }
        textStyle={{
          color:"#0B1742",
        }}
