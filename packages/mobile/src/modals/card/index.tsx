...
export const CardModal: FunctionComponent<{
  ...
  const [, setSoftwareKeyboardBottomPadding] = useState(0);
  ...
  useEffect(() => {
    ...
    if (Platform.OS !== "android") {
      ...
      return () => {
        // Keyboard.removeAllListeners("keyboardWillShow", onKeyboarFrame);
        // Keyboard.removeAllListeners("keyboardWillChangeFrame", onKeyboarFrame);
        // Keyboard.removeAllListeners("keyboardWillHide", onKeyboardClearFrame);
      };
    }
  ...
  return (
    ...
    >
      ...
      <View>
        {/* style={style.flatten(["items-center", "margin-bottom-16"])} */}
        <View>
          {!disableGesture ? (
            <View
            // style={style.flatten([
