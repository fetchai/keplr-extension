          ...
          style={{
            background:
              operation == ValidatorOperation.VALIDATOR
                ...
                : "transparent",
            color:
              operation == ValidatorOperation.VALIDATOR ? "black" : "white",
          }}
          onClick={() => {
          ...
          style={{
            background:
              operation == ValidatorOperation.MY_STAKE
                ...
                : "transparent",
            color:
              operation == ValidatorOperation.MY_STAKE ? "#000D3D" : "white",
          }}
          onClick={() => {
        ...
        >
          <div className={style["loader"]}>
            <svg viewBox="0 0 80 80">
              <rect x="8" y="8" width="64" height="64" color="white" />
            </svg>
          </div>
          <br />
          <span style={{ color: "white" }}>Loading Validators</span>
        </div>
      )}
